...
app.get('/', (req, res) => {
  res.json({
    ...
    status: 'running',
    endpoints: ['/tasks', '/calendar', '/time', '/tts', '/health', '/chat', '/skills', '/snippets', '/projects', '/resources', '/contacts', '/today', '/learning', '/travel', '/watchlist', '/meals', '/reading', '/subscriptions', '/gifts', '/habits', '/routines', '/goals'],
